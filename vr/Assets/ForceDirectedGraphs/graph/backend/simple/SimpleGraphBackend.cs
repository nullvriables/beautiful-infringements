...
namespace AssemblyCSharp
{
	public class SimpleGraphBackend : AbstractGraphBackend
	{
		...
		public override AbstractGraphNode NewNode (bool suburb)
		{
			SimpleGraphNode newNode = new SimpleGraphNode (this, AllGraphNodes.Count, "test", suburb);
		...
		{
			SimpleGraphEdge newEdge = new SimpleGraphEdge (AllGraphEdges.Count,"Test", from, to);
